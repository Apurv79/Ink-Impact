  ...
  return (
    <div className="w-full">
      ...
      <Controller
        name={name || "content"}
        control={control}
        defaultValue={defaultValue} // ✅ Ensure default value is passed correctly
        render={({ field: { onChange, value } }) => (
          <Editor
            apiKey="l2p1wmlv8if9bovhjlrece79mv9yp35jgc7xbvukeqkn2ed7"
            init={{
              plugins: [
            ...
            value={value} // ✅ Sync editor with form state
            onEditorChange={(content) => onChange(content)} // ✅ Correctly update form state
          />
        )}
      />
    </div>
